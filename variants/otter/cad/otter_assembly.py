"""Standing otter, exact existing OLED face pixels plus nominal electronics."""
import json
from pathlib import Path
from otter_common import *
from otter_body import gen_raw as body_shape
from otter_back import gen_raw as back_shape
from otter_c3_tray import gen_raw as tray_shape
...
def gen_step():
    return Compound(label='Piku_the_little_otter',children=[STAND*p for p in raw_parts()])
