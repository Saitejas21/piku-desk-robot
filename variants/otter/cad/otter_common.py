"""Piku otter parameters, mm. Raw X=width, Y=height, +Z=front to rear.
...
HEAD_W, HEAD_H, HEAD_Y, HEAD_R = 64.0,50.0,60.0,24.0
...
SCREWS=[(-26.8,64.0),(26.8,64.0),(-19.5,15.0),(19.5,15.0)]
BROWN=Color(0.42,0.265,0.17)
CREAM=Color(0.91,0.79,0.57)
...
def tail_shape(clearance=0):
    # Tail belongs to the body; the lid has a matching clearance notch.
    shape=ellipsoid(11+clearance,7+clearance,25+clearance,0,5,34)
    return shape & block(-20,20,0,14+clearance,0,65)
