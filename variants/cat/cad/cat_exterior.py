...
# Cosmetic envelope scales only; the electronics core is never scaled.
HEAD_X_SCALE=0.91
HEAD_Y_SCALE=0.92
# A 0.01 mm separation avoids coincident spline/planar front caps.
HEAD_FRONT_RECESS=1.21
CHEST_HEIGHT_SCALE=1.065
...
def pear_profile(scale=1):
    ...
    points=[(0,50),(13,47),(21,39),(26,29),(29.5,18),(28.5,9),
            ...
            (-21,39),(-13,47)]
    pts=[(x*scale,(26+(y-26)*scale)*CHEST_HEIGHT_SCALE) for x,y in points]
...
def feline_head():
    ...
    for z,s in [(-1.2,.76),(2,.90),(10,1),(28,1),(39,.90)]:
        pts=[(x*s*HEAD_X_SCALE,60+(y-60)*s*HEAD_Y_SCALE) for x,y in points]
        z_adjusted=z+HEAD_FRONT_RECESS*(39-z)/40.2
        profiles.append(Pos(0,0,z_adjusted)*Face(Wire([Spline(*pts,periodic=True)])))
