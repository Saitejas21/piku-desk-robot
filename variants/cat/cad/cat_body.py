...
def display_bezel():
    ...
    return rolled(42,26,7.5,2.4,OLED_Y,0,0.7)
...
def gen_raw(clips=True):
    ...
    for side in (-1,1):
        ...
        for dy in (-4,0,4):
            # Follow the smaller cosmetic face surface; no hardware is moved.
            body-=ellipsoid(3.0,0.34,0.6,side*24.2,OLED_Y+dy,0.1,angle=side*dy*2)
    for x,y in SCREWS:
