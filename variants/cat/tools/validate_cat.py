...
from cat_body import gen_raw as body_shape,gen_step as body_print
from cat_back import gen_raw as back_shape,gen_step as back_print
from cat_c3_tray import gen_raw as tray_shape,gen_step as tray_print
from cat_body_tape import gen_step as tape_print
from cat_oled_fit_test import gen_step as oled_test
from cat_touch_fit_test import gen_step as touch_test
...
for name,shape in [('cat_body',body_print()),('cat_back',back_print()),('cat_c3_tray',tray_print()),
                   ('cat_body_tape',tape_print()),('cat_oled_fit_test',oled_test()),('cat_touch_fit_test',touch_test())]:
...
report['closed_body_depth_mm']=REAR+LID_T-body.bounding_box().min.Z
